...
const Contact = () => {
  return (
    <section className="max-sm:mt-[80px] mt-[135px] py-20 max-lg:px-6 max-sm:px-3 lg:px-8 md:w-full md:mx-auto flex flex-wrap md:flex-nowrap   max-lg:gap-0 lg:gap-30">
        ...
        <div className="flex flex-wrap mt-12">
          {Array.from({ length: 4 }).map((item, index) => (
            <div className="md:w-1/2 md:px-6 mb-10 md:mb-20" key={index}>
              <MdLocationOn className="text-[#1CBA9F] scale-[2.2] sm:scale-[3.3] sm:mb-8 ml-2" />
              <h1 className="exo text-[20px] sm:text-[22px] mt-[18px] mb-[10px] text-[#22222] font-[700] leading-[1.4em] ">
                Address
              </h1>
              <span className=" text-[14px] sm:text-[16px] text-[rgba(34_34_34),0.7] roboto font-[400] leading-[1.7em]">
      ...
      <div className="md:min-h-screen w-full flex flex-col px-6 lg:px-12 py-10 lg:pt-24 mx-auto rounded-xl bg-[#223a66]/90 md:mx-auto lg:mx-0 md:w-2/3 lg:w-2/5 h-1/2 text-white mt-6 md:mt-0">
