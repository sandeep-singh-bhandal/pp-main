...
const Product = ({ name }: { name: string }) => {
  return (
    <section className="mt-[135px] w-full">
      <GreenOverlay />
      <div className="w-3/4 mx-auto py-32 px-12 flex gap-24">
        ...
        <div className="w-7/12">
          <div className="mb-4">
            ...
            <p className="exo text-[24px] mb-2 text-[#222] ">{name}</p>
          ...
          <div>
            ...
            <p className="roboto text-[16px] text-[#555] ">
              Azithromycin is used to treat a wide variety of bacterial
              infections. It is a macrolide-type antibiotic. It works by
              stopping the growth of bacteria. This medication will not work for
              viral infections (such as common cold, flu). Unnecessary use or
          ...
          <ul className="flex flex-col gap-2">
            {Array.from({ length: 4 }).map((_, index) => (
              <li
                ...
                key={index}
              >
                - Take this medicine by mouth. Follow the directions on the
                prescription label.
              </li>
            ))}
          </ul>
