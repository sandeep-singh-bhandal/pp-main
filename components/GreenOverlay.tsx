...
const GreenOverlay = () => {
  return (
    <div className="relative">
      <div className="relative bg-[#1cba9f] bg-[url('/images/background/1.png')] bg-no-repeat bg-left max-sm:bg-none bg-contain before:content-[''] before:absolute before:inset-0 before:bg-[#1cba9f]/80 before:z-0">
